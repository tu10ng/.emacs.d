...
*** TODO keyboard shortcut: advise `browse-url-at-point' disable error message
#+begin_src emacs-lisp
...
(rainbow-cursor-enable)
    ...
    #+RESULTS:
    : [nil 25261 29739 224681 0.05 cursor-color-change nil nil 455000 nil]
