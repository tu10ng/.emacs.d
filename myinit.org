...
;;   (interactive)
;;   (toggle-input-method)
;;   (if (eq current-input-method nil)     ;is english
;;       (setq awesome-tray-mode-line-active-color "DarkBlue")
;;     (setq awesome-tray-mode-line-active-color "DarkRed"))
...
(use-package shackle                    ;*customize* not working?
  ...
  (shackle-rules '((magit-status-mode    :select t :align right :size 0.2)
...
(use-package flycheck
  ...
  (flycheck-idle-change-delay 0.05))
